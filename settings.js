...
global.owner = process.env.OWNER_NUMBER  || '94718558725' ;  // ADD YOUR NUMBER WITHOUT +
    
module.exports = {
SESSION_ID: process.env.SESSION_ID || 'VAJIRA-MD=mQtTlDSY#TgrnT-i6HD5jCIc-a7sMgY8qHBCK3IiT7x15VsEpzQg' ,
